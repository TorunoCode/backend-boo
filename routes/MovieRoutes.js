...
movieRoute.get(
    ...
    asyncHandler(async (req, res) => {
        ...
        var text = req.params.startTime.slice(0,10)+ "T00:00:00.000Z";
        console.log(text);
        let check = await ShowingModel.distinct('time',{idCinema:req.params.idCinema,idHall:req.params.idHall,startTime:text});
        console.log(check);
